...
parser.add_argument("--model", default="ernie-3.0-medium-zh", type=str, help="backbone of encoder.")
...
parser.add_argument("--num_labels", default=21, type=int, help="Total classes of labels.")
        ...
        for epoch in range(1, args.num_train_epochs+1):
            for batch in train_dataloader:
                ...
                if global_step % args.logging_steps == 0:
                    ...
                    str_temp = "global step %d, epoch: %d, loss: %.5f, speed: %.2f step/s" \
